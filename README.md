# cloud-itonami-iso3166-sen

Open ISO 3166 Blueprint for **SEN**: Senegal.
...
tax registration, and local-content rules in Senegal, so the operator
...
- **Not the government of Senegal.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Senegalese-licensed counsel
...
(ISO 3166 `SEN`). Required capabilities:
